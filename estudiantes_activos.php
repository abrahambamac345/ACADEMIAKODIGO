                ...
                <tbody>
                    <?php foreach($arreglo_datos as $item){ ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#reubicar<?php echo $item["id"]; ?>">Reubicar</button>
                                ...
                                <div class="modal fade" id="reubicar<?php echo $item["id"]; ?>" tabindex="-1" aria-labelledby="reubicarLabel<?php echo $item["id"]; ?>" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="reubicacion_estudiantes.php" method="POST">
