...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['id_estudiante'], $_POST['nuevoBootcamp'])) {
    ...
    if ($resultado) {
        header('Location: reubicacion_estudiantes.php.php?reubicacion=exito');
    } else {
        header('Location: reubicacion_estudiantes.php.php?reubicacion=error');
    }
}
?>
...
<body>
    <?php include "./modulos/header.php";
        ...
        $estudiante = new Estudiante();
        $arreglo_reubicados = $estudiante->getReubicados();
    ?>
