...
class Estudiante extends Conexion{
    ...
    #metodo para obtener los bootcamps de reubicacion
    ...
    public function getReubicados() {
        $pdo = $this->conectar();
        $query = $pdo->query("SELECT estudiantes.*, bootcamp.bootcamp, estado.estado FROM estudiantes INNER JOIN bootcamp ON estudiantes.id_bootcamp = bootcamp.id INNER JOIN estado ON estudiantes.id_estado = estado.id WHERE estudiantes.id_estado = 2");
